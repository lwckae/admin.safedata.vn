...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?=$this->config->item('adminLTE');?>plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Đăng nhập hệ thống quản lý tập chung</p>

      <form action="<?=$this->config->item('loginProcess');?>" method="post">
