  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url($this->config->item('adminView'));?>" class="nav-link">Trang Chủ</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?=base_url($this->config->item('adminView'));?>" class="brand-link">
      <img src="https://www.senbac.com/wp-content/uploads/2016/09/cropped-SENBAC_final_black-270x270.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url($this->config->item('adminView'));?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url().$this->config->item('logout');?>" class="nav-link">
